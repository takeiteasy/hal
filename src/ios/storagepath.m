...
// iOS storagepath using NSSearchPathForDirectoriesInDomains (sandboxed)
...
// iOS is sandboxed - most desktop directories don't apply
const char* hal_path_downloads(void) {
    return hal_path_documents(); // Maps to Documents
}
...
const char* hal_path_appdata(void) {
    return get_ns_path(NSApplicationSupportDirectory, cache_buf);
}
