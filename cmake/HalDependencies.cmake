...
function(hal_add_module_dependencies MODULE_NAME)
  ...
  if(HAL_PLATFORM_IOS)
    ...
    elseif(MODULE_NAME STREQUAL "clipboard")
      ...
      find_library(UIKIT_FRAMEWORK UIKit REQUIRED)
      list(APPEND HAL_LINK_LIBRARIES ${FOUNDATION_FRAMEWORK} ${UIKIT_FRAMEWORK})
    elseif(MODULE_NAME STREQUAL "file_chooser")
      # iOS file chooser uses UIDocumentPickerViewController
      find_library(FOUNDATION_FRAMEWORK Foundation REQUIRED)
      find_library(UIKIT_FRAMEWORK UIKit REQUIRED)
  ...
  if(HAL_PLATFORM_MACOS)
    ...
    elseif(MODULE_NAME STREQUAL "file_chooser")
      # macOS file chooser uses NSOpenPanel/NSSavePanel from AppKit
      find_library(FOUNDATION_FRAMEWORK Foundation REQUIRED)
      find_library(APPKIT_FRAMEWORK AppKit REQUIRED)
      find_library(UNIFORMTYPEIDENTIFIERS_FRAMEWORK UniformTypeIdentifiers REQUIRED)
